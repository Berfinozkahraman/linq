...
public class ABCD
{
    static public void Main()
    {
        List<Calisan> cal = new List<Calisan>()
        {
            ...
            new Calisan(){cal_id=210,cal_name="Mira", cal_cinsiyet="Kadın",
            cal_year="5", cal_maas= 22000},
            new Calisan(){cal_id=211,cal_name="Reyyan", cal_cinsiyet="Kadın",
            cal_year="5", cal_maas= 27000},
            new Calisan(){cal_id=212,cal_name="Aleyna", cal_cinsiyet="Kadın",
            cal_year="5", cal_maas= 28000},
             new Calisan(){cal_id=213,cal_name="Pınar", cal_cinsiyet="Kadın",
            cal_year="5", cal_maas= 29000}
        };
